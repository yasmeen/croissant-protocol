...
export declare const ContractVersions: Record<SupportedNetworks, Record<KnownContracts, {
...
export declare const ContractFactories: {
    ...
    packer: typeof factories.Packer__factory;
    integrity: typeof factories.Integrity__factory;
};
