...
export interface Integrity extends BaseContract {
    ...
    functions: {
        enforce(conditions: ConditionFlatStruct[], overrides?: CallOverrides): Promise<[void]>;
    };
    enforce(conditions: ConditionFlatStruct[], overrides?: CallOverrides): Promise<void>;
    callStatic: {
        enforce(conditions: ConditionFlatStruct[], overrides?: CallOverrides): Promise<void>;
    ...
    filters: {};
    estimateGas: {
        enforce(conditions: ConditionFlatStruct[], overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        enforce(conditions: ConditionFlatStruct[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
