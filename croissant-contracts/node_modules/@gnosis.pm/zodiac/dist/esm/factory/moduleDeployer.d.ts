...
export declare const getModuleInstance: <T extends KnownContracts>(moduleName: T, moduleAddress: string, provider: Provider | Signer) => ReturnType<{
    bridge: typeof import("../types").Bridge__factory;
    circulatingSupplyERC20: typeof import("../types").CirculatingSupplyErc20__factory;
    circulatingSupplyERC721: typeof import("../types").CirculatingSupplyErc721__factory;
    delay: typeof import("../types").Delay__factory;
    erc20Votes: typeof import("../types").Erc20Votes__factory;
    erc721Votes: typeof import("../types").Erc721Votes__factory;
    exit: typeof import("../types").ExitErc20__factory;
    exitERC721: typeof import("../types").ExitErc721__factory;
    factory: typeof ModuleProxyFactory__factory;
    metaGuard: typeof import("../types").MetaGuard__factory;
    optimisticGovernor: typeof import("../types").OptimisticGovernor__factory;
    ozGovernor: typeof import("../types").OzGovernor__factory;
    realityERC20: typeof import("../types").RealityErc20__factory;
    realityETH: typeof import("../types").RealityEth__factory;
    roles: typeof import("../types").Roles__factory;
    scopeGuard: typeof import("../types").ScopeGuard__factory;
    tellor: typeof import("../types").Tellor__factory;
    multisendEncoder: typeof import("../types").MultisendEncoder__factory;
    permissions: typeof import("../types").Permissions__factory;
    connext: typeof import("../types").Connext__factory;
    packer: typeof import("../types").Packer__factory;
    integrity: typeof import("../types").Integrity__factory;
}[T]["connect"]>;
