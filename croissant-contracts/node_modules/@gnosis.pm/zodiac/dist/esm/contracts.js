 ...
 * @deprecated
 **/
export const MasterCopyAddresses = Object.fromEntries(Object.entries(CanonicalAddresses).map(([key, value]) => [
    key,
    Object.values(value).pop() || "",
]));
/** Addresses of all deployed contracts in all versions */
export const ContractVersions = {
    [SupportedNetworks.Mainnet]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
            "1.2.0": "0x28CeBFE94a03DbCA9d17143e9d2Bd1155DC26D5d",
        }, [KnownContracts.TELLOR]: {
            "2.1.0": "0xaB80413Ab8C4aF91Af5F349352a0c92CF3A30D18",
        } }),
    [SupportedNetworks.Goerli]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
    ...
    [SupportedNetworks.GnosisChain]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
            "1.2.0": "0x972396Ab668cd11dc1F6321A5ae30c6A8d3759F0",
        } }),
    [SupportedNetworks.Polygon]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
    ...
    [SupportedNetworks.ArbitrumOne]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
            "1.2.0": "0x30679ca4ea452d3df8a6c255a806e08810321763",
        } }),
    [SupportedNetworks.Optimism]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.OPTIMISTIC_GOVERNOR]: {
            "1.2.0": "0x357fe84E438B3150d2F68AB9167bdb8f881f3b9A",
        } }),
    [SupportedNetworks.Avalanche]: Object.assign(Object.assign({}, CanonicalAddresses), { [KnownContracts.TELLOR]: {}, [KnownContracts.OPTIMISTIC_GOVERNOR]: {
            "1.2.0": "0xEF8b46765ae805537053C59f826C3aD61924Db45",
        } }),
};
/** Addresses of the head versions of all contracts */
export const ContractAddresses = Object.fromEntries(Object.entries(ContractVersions).map(([network, contracts]) => [
    network,
...
export const ContractFactories = {
    ...
    [KnownContracts.CIRCULATING_SUPPLY_ERC20]: factories.CirculatingSupplyErc20__factory,
    [KnownContracts.CIRCULATING_SUPPLY_ERC721]: factories.CirculatingSupplyErc721__factory,
...
export const MasterCopyInitData = {
