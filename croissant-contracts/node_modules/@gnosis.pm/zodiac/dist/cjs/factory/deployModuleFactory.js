...
const FactoryInitData = contracts_1.MasterCopyInitData[types_1.KnownContracts.FACTORY];
/**
...
const deployModuleFactory = async (signer) => {
    ...
    const targetAddress = await singletonFactory.callStatic.deploy(FactoryInitData.initCode, FactoryInitData.salt);
    ...
    const transactionResponse = await singletonFactory.deploy(FactoryInitData.initCode, FactoryInitData.salt, { gasLimit: 1000000 });
